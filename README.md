...
Para a utilização de API GEOCODE, se fez uso da  **[Google Dev](https://www.google.com/intl/pt-BR/chrome/dev/)**. Sua chave de API foi guardado em uma variável de ambiente, de forma a não ser compartilhada
<br>
